...
const featured = [
  {
    number: '01',
    title: 'Suvarna Sutra Daru',
    subtitle: 'Rumah Tinggal',
    category: 'Bangun Baru',
    location: 'Cikupa, Tangerang',
    duration: '9 bulan',
    year: '2022',
    scope: 'Pembangunan dari nol — struktur, MEP, finishing, taman eksterior, dan ornamen fasad batu alam',
  ...
  },
  {
    ...
    duration: '9 bulan',
    year: '2021',
    scope: 'Struktur, arsitektur, MEP, finishing interior dan eksterior lengkap',
